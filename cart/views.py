...
def sendEmail(order_id):
    ...
    try:
        '''Sending the order'''
        print('came for sending messages')
        subject = "Perfect Cushion Store - New Order #{}".format(transaction.id)
        to = ['{}'.format(transaction.emailAddress)]
        from_email = "sujithpython2710@gmail.com"  # hardcoded value.....
        ...
        print('came for sending messages', message)
        ...
        # 	    'Purchase mail',
        # 	    msg,
        # 	    'sujithpython2710@gmail.com',
        # 	    ['sujithmg11@yahoo.com'],
        # 	    fail_silently=False,
        # 	)
    except IOError as e:
        return e
